...
<div class="col-sm-12 col-md-8">
    <div class="form-group">
        ...
        class="form-control" placeholder="ej: Gaspar Ake">
...
<div class="col-sm-12 col-md-4">
    <div class="form-group">
        ...
        class="form-control" placeholder="ej: 9911074694" maxlength="10">
...
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        ...
        class="form-control" placeholder="ej: gaspar070102@gmail.com" >

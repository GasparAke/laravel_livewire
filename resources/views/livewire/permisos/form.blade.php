    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-sm-12">
              <div class="input-group">
                  ...
                  <input type="text" wire:model.lazy="permissionName" class="form-control" placeholder="ej: Category_dex"
                  maxlength="255">
              </div>
              @error('permissionName') <span class="tex danger er">{{ $message }}</span> @enderror
          </div>
        </div>
        ...
        <div class="modal-footer">
          ...
          text-info" data-dismiss="modal">Cerrar</button>

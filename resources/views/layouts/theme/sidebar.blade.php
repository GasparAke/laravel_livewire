            ...
            <li class="">
                <a href="{{url('products')}}" class="menu-toggle" data-active="false">
                    <div class="base-menu">
                        ...
                        7.17a2 2 0 0 1-2.83 0L2 12V2h1018.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7"
            ...
            <li class="">
                <a href="{{url('cashout')}}" class="menu-toggle" data-active="false">
                    <div class="base-menu">
                        ...
                        x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6
                        "></path></svg>
                        </div>
